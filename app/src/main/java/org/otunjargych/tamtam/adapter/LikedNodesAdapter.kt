...
import org.otunjargych.tamtam.databinding.SwipeItemBinding
...
class LikedNodesAdapter : RecyclerView.Adapter<LikedNodesAdapter.AdOneViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdOneViewHolder {
        ...
        val binding = SwipeItemBinding.inflate(inflater, parent, false)
    ...
    inner class AdOneViewHolder(val binding: SwipeItemBinding) : RecyclerView.ViewHolder(binding.root) {
