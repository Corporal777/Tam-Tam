package org.otunjargych.tamtam.ui.my.active
...
class ActiveNotesFragment(private val onScrollState: MyNotesFragment.OnScrollStateChange) :
    BaseFragment<MyNotesViewModel, FragmentMyNotesListBinding>() {


    private val notesSection by lazy {
        Section().apply {
            setHeader(TitleItemHome("Активные объявления"))
